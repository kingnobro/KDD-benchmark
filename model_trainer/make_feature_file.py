...
def Make_feature_file(authorIdPaperIds, dict_coauthor, dict_paperIdAuthorId_to_name_aff, PaperAuthor, Author, Paper, Conference, Journal, feature_function_list, to_file):
    example_list = []
    dimension = 0
    ...
    for authorIdPaperId in authorIdPaperIds:
        ...
        features = [feature_function(authorIdPaperId, dict_coauthor, dict_paperIdAuthorId_to_name_aff, PaperAuthor, Author, Paper, Conference, Journal) for feature_function in feature_function_list]
        # 合并特征
